...
function TopBar({ tab, setTab }: { tab: Tab; setTab: (t: Tab) => void }) {
  return (
    ...
    >
      ...
      <span
        title="Educational model built for intuition, not operational accuracy. Some details may be simplified or wrong. See github.com/NVIDIA/infra-controller for the real project."
        style={{
          marginLeft: 'auto',
          fontFamily: MONO,
          fontSize: 11,
