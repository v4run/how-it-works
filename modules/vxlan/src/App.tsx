    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
        ...
        <span style={{ fontFamily: DISP, fontSize: 17, fontWeight: 700, color: C.ink, letterSpacing: '-0.01em' }}>
          VXLAN <span style={{ color: C.faint, fontWeight: 400 }}>Virtual Extensible LAN</span>
        </span>
      ...
      <span
        title="Educational model built for intuition, not operational accuracy. Some details are simplified — real EVPN/VXLAN has more nuance (L3 VNIs, multihoming, symmetric IRB, etc.)."
        style={{
          marginLeft: 'auto',
          fontFamily: MONO,
          fontSize: 11,
      ...
      <div style={{ fontFamily: MONO, fontSize: 12, color: C.faint, letterSpacing: '0.12em' }}>
        {tab === 'lab' ? 'segment · encap · isolate' : 'space ▸ play · ← → seek'}
      </div>
    </div>
  );
}
