    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
        ...
        <span style={{ fontFamily: DISP, fontSize: 17, fontWeight: 700, color: C.ink, letterSpacing: '-0.01em' }}>
          MetalLB <span style={{ color: C.faint, fontWeight: 400 }}>bare-metal load balancer</span>
        </span>
        <span style={{ fontFamily: MONO, fontSize: 12, color: C.faint, letterSpacing: '0.18em', textTransform: 'uppercase', marginLeft: 4 }}>L2 · BGP</span>
      </div>
      ...
      <span
        title="Educational model built for intuition, not operational accuracy. Real MetalLB has more nuance (memberlist timing, BGP attributes/communities, FRR mode, IP-sharing, etc.)."
        style={{
          marginLeft: 'auto',
          fontFamily: MONO,
          fontSize: 11,
      ...
      <div style={{ fontFamily: MONO, fontSize: 12, color: C.faint, letterSpacing: '0.12em' }}>{tab === 'lab' ? 'pool · allocate · announce' : 'space ▸ play · ← → seek'}</div>
    </div>
  );
}
